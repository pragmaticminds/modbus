...
public interface ServiceRequestHandler {
    ...
    default void onCommunicationTest(ServiceRequest<CommunicationTestRequest, CommunicationTestResponse> service) {
        service.sendException(ExceptionCode.IllegalFunction);
        ReferenceCountUtil.release(service.getRequest());
    }

    default void onPBGetVariable(ServiceRequest<PBGetVariableRequest, PBGetVariableResponse> service) {
        service.sendException(ExceptionCode.IllegalFunction);
        ReferenceCountUtil.release(service.getRequest());
    }

    default void onPBSetAndGetVariable(ServiceRequest<PBSetAndGetVariableRequest, PBSetAndGetVariableResponse> service) {
        service.sendException(ExceptionCode.IllegalFunction);
        ReferenceCountUtil.release(service.getRequest());
    }

    default void onPBGetCommandPackage(ServiceRequest<PBGetCommandPackageRequest, PBGetCommandPackageResponse> service) {
        service.sendException(ExceptionCode.IllegalFunction);
        ReferenceCountUtil.release(service.getRequest());
    }

    default void onPBSetAndGetCommandPackage(ServiceRequest<PBSetAndGetCommandPackageRequest, PBSetAndGetCommandPackageResponse> service) {
        service.sendException(ExceptionCode.IllegalFunction);
        ReferenceCountUtil.release(service.getRequest());
    }
